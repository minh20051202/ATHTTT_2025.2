...
async function buildOAuth2StepsFull({
  oauth2Credentials,
  latestResult,
  fetchToken,
}) {
...
function Badge({ type }) {
  ...
  return (
    <span
      className={`badge ${isAgent ? "badge-oauth2" : "badge-zkp"}`}
...
export default function ActionLog({
  ...
  useEffect(() => {
    ...
    async function buildSteps() {
      ...
      setSteps([
        ...newSteps,
        ...buildReasoningSteps(latestResult, liveReasoningSteps),
      ]);
    }
    buildSteps();
  ...
  return (
    <div className="sidebar-panel" style={{ height: "100%" }}>
      <div className="panel-header">
        ...
        <span
          className={`badge ${authType === "zkp" ? "badge-zkp" : "badge-oauth2"}`}
        >
